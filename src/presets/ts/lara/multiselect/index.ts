    ...
    return {
      class: [
        ...
        // Spacing
        {
          ...
          'py-3 px-3':
            props.display === 'chip' &&
            !((_a = props == null ? void 0 : props.modelValue) != null && _a.length),
          'py-[0.375rem] px-3':
            props.display === 'chip' &&
            ((_b = props == null ? void 0 : props.modelValue) == null ? void 0 : _b.length) > 0
        },
        // Color
        {
          'text-surface-800 dark:text-white/80':
            (_c = props.modelValue) == null ? void 0 : _c.length,
          'text-surface-400 dark:text-surface-500': !((_d = props.modelValue) != null && _d.length)
        },
